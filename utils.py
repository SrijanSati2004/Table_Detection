...
def ConvertToImage(pdf_path, output_path):
    ...
    for i, image in enumerate(images):
        image.save(f'{output_path}/{pdf_name}_page_{i+1}.png', 'PNG')

def expand_bbox_relative(bbox, margin_ratio=0.05):
    '''
    This function expands the orignal bounding box for better structure recognition.
    returns : list of new coordinates.
    '''
    x0, y0, x1, y1 = bbox
